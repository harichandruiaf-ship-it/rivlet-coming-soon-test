...
const techs: {
  ...
  { n: "04", name: "TerraWeave", desc: <>Cotton, hemp, <em>linen — blended.</em></>, tag: "Natural blend", bg: "/assets/tech-terraweave.jpg" },
    ...
    <section ref={fabRef} className={"fab section-await" + (fabRevealed ? " reveal-in" : "")} id="promises">
      <div className="fab-head">
        ...
        <div className="meta">
          ...
          <br />
          Engineered in-house. Named, tracked, perfected — and held to a single standard: disappear on the body.
        </div>
      </div>
