...
export function buildSiteIdentityJsonLd() {
    ...
    const organization = {
        ...
        description: "Rivlet is a premium Indian-crafted activewear, sportswear, athleisure and easy wear brand. Born in Madurai, Tamil Nadu. Manufactured in India to global standards. Built without compromise.",
    ...
    const brandEntity = {
        ...
        name: "Rivlet",
        alternateName: ["Rivlet Activewear", "Rivlet India"],
        description: "Premium Indian activewear, sportswear, athleisure and easy wear brand. Six proprietary fabric technologies. Built without compromise.",
